...
def main(args):
    ...
    # Set to None to disable visualization during validation sampling
    visualization_tools = None

    if args.model in ['RGR', 'RetroBridge']:
        model = MarkovBridge(
    ...
    trainer = Trainer(
        ...
        check_val_every_n_epoch=args.sample_every_val,
    )
